...
config :flixora, :scopes,
  user: [
    default: true,
    module: Flixora.Accounts.Scope,
    assign_key: :current_scope,
    access_path: [:user, :id],
    schema_key: :user_id,
    schema_type: :id,
    schema_table: :users,
    test_data_fixture: Flixora.AccountsFixtures,
    test_setup_helper: :register_and_log_in_user
  ]

config :flixora,
  ecto_repos: [Flixora.Repo],
...
config :flixora, Flixora.Mailer, adapter: Swoosh.Adapters.Local
