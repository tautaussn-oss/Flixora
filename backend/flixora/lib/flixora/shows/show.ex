defmodule Flixora.Shows.Show do
  use Ecto.Schema
  ...
  schema "shows" do
    ...
    many_to_many :genres, Flixora.Genres.Genre, join_through: "shows_genres", on_replace: :delete
    many_to_many :actors, Flixora.Actors.Actor, join_through: "shows_actors", on_replace: :delete
