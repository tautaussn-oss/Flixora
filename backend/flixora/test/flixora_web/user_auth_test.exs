defmodule FlixoraWeb.UserAuthTest do
  use FlixoraWeb.ConnCase, async: true

  alias Flixora.Accounts
  alias Flixora.Accounts.Scope
  alias FlixoraWeb.UserAuth

  import Flixora.AccountsFixtures

  @remember_me_cookie "_flixora_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FlixoraWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
